...
var getColor = function (color, tokens, mode) {
    return tokens
        ...
        var restoredValue = getRestoredColorFromPalette(value);
...
export var createColorTokens = function (themeDir, color, tokens) { return __awaiter(void 0, void 0, void 0, function () {
