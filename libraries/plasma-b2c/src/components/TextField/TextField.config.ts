    ...
    variations: {
        view: {
            default: {
                ...
                backgroundColorFocus: data.color[mode].surfaceTransparentSecondary,
            ...
            positive: {
                ...
                backgroundColorFocus: data.color[mode].surfaceTransparentPositiveActive,
                caretColor: data.color[mode].textAccent,
                placeholderColor: data.color[mode].textSecondary,
                labelColor: data.color[mode].textPrimary,
            ...
            warning: {
                ...
                backgroundColorFocus: data.color[mode].surfaceTransparentWarningActive,
                caretColor: data.color[mode].textAccent,
                placeholderColor: data.color[mode].textSecondary,
                labelColor: data.color[mode].textPrimary,
            ...
            negative: {
                ...
                backgroundColorFocus: data.color[mode].surfaceTransparentNegativeActive,
                caretColor: data.color[mode].textAccent,
                placeholderColor: data.color[mode].textSecondary,
                labelColor: data.color[mode].textPrimary,
