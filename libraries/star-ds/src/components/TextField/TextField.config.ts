...
export const getConfig = ({ data, mode, screenSize }: Theme<StylesSaluteTheme>) => ({
    ...
    variations: {
        view: {
            ...
            negative: {
                color: data.color[mode].textPrimary,
                backgroundColor: 'rgba(255, 41, 62, 0.2)', // TODO: data.color[mode].surfaceTransparentNegative,
                backgroundColorActive: 'rgba(255, 41, 62, 0.2)', // data.color[mode].surfaceTransparentNegativeActive,
