...
export const BankCardLockFill: React.FC<IconProps> = (props) => (
    <s.Svg viewBox="0 0 24 24" width={24} height={24} fill="none" {...props}>
        ...
        />
        <s.Path
            d="M17.5 14.5C16.9478 14.5 16.5 14.9477 16.5 15.5V16.5H18.5V15.5C18.5 14.9478 18.0523 14.5 17.5 14.5Z"
            fill="currentColor"
        />
        <s.Path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M17.5 23C20.5376 23 23 20.5376 23 17.5C23 14.4624 20.5376 12 17.5 12C14.4624 12 12 14.4624 12 17.5C12 20.5376 14.4624 23 17.5 23ZM19.5 15.5V16.5C20.0523 16.5 20.5 16.9477 20.5 17.5V20C20.5 20.5523 20.0523 21 19.5 21H15.5C14.9477 21 14.5 20.5523 14.5 20V17.5C14.5 16.9477 14.9477 16.5 15.5 16.5V15.5C15.5 14.3954 16.3957 13.5 17.5 13.5C18.6046 13.5 19.5 14.3957 19.5 15.5Z"
            fill="currentColor"
        />
    </s.Svg>
);
