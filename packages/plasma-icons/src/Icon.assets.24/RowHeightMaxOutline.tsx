...
export const RowHeightMaxOutline: React.FC<IconProps> = (props) => (
    <s.Svg viewBox="0 0 24 24" width={24} height={24} fill="none" {...props}>
        ...
        <s.Path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M5.5 6H18.5C19.8807 6 21 7.11929 21 8.5V15.5C21 16.8807 19.8807 18 18.5 18H5.5C4.11929 18 3 16.8807 3 15.5V8.5C3 7.11929 4.11929 6 5.5 6ZM5.5 7.5C4.94772 7.5 4.5 7.94772 4.5 8.5V15.5C4.5 16.0523 4.94772 16.5 5.5 16.5H18.5C19.0523 16.5 19.5 16.0523 19.5 15.5V8.5C19.5 7.94772 19.0523 7.5 18.5 7.5H5.5Z"
            fill="currentColor"
        />
        <s.Path
