...
export const ZoomPlusOutline: React.FC<IconProps> = (props) => (
    <s.Svg viewBox="0 0 24 24" width={24} height={24} fill="none" {...props}>
        <s.Path
            d="M11.25 7C11.25 6.58579 10.9142 6.25 10.5 6.25C10.0858 6.25 9.75 6.58579 9.75 7V9.75H7C6.58579 9.75 6.25 10.0858 6.25 10.5C6.25 10.9142 6.58579 11.25 7 11.25H9.75V14C9.75 14.4142 10.0858 14.75 10.5 14.75C10.9142 14.75 11.25 14.4142 11.25 14V11.25H14C14.4142 11.25 14.75 10.9142 14.75 10.5C14.75 10.0858 14.4142 9.75 14 9.75H11.25V7Z"
            fill="currentColor"
        />
        <s.Path
            fillRule="evenodd"
