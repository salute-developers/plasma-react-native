...
export const CursorFill: React.FC<IconProps> = (props) => (
    <s.Svg viewBox="0 0 36 36" width={36} height={36} fill="none" {...props}>
        <s.Path
            d="M9.76071 7.24695C9.18936 6.97076 8.55459 7.48479 8.70595 8.10108L14.4483 31.4819C14.6261 32.2055 15.636 32.2553 15.884 31.5526L19.5808 21.0759C19.6749 20.8094 19.9108 20.6184 20.191 20.5818L31.2074 19.1439C31.9462 19.0475 32.1076 18.0493 31.4367 17.725L9.76071 7.24695Z"
            fill="currentColor"
        />
        <s.Path
            fillRule="evenodd"
