...
export const ZoomPlusOutline: React.FC<IconProps> = (props) => (
    <s.Svg viewBox="0 0 36 36" width={36} height={36} fill="none" {...props}>
        <s.Path
            d="M16.5 10.5C16.5 9.94772 16.0523 9.5 15.5 9.5C14.9477 9.5 14.5 9.94772 14.5 10.5V14.5H10.5C9.94772 14.5 9.5 14.9477 9.5 15.5C9.5 16.0523 9.94772 16.5 10.5 16.5H14.5V20.5C14.5 21.0523 14.9477 21.5 15.5 21.5C16.0523 21.5 16.5 21.0523 16.5 20.5V16.5H20.5C21.0523 16.5 21.5 16.0523 21.5 15.5C21.5 14.9477 21.0523 14.5 20.5 14.5H16.5V10.5Z"
            fill="currentColor"
        />
        <s.Path
            fillRule="evenodd"
