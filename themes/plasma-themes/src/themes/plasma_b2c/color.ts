export const color = {
    dark: {
        ...
        textInfoHover: '#90B6FEFF',
        /** dark text default textInfoActive */
        textInfoActive: '#216EFDFF',
        ...
        onDarkTextInfoHover: '#90B6FEFF',
        /** dark text onDark textInfoActive */
        onDarkTextInfoActive: '#216EFDFF',
        ...
        /** Акцентный цвет на темном фоне */
        onDarkTextAccentHover: '#90B6FEFF',
        /** Акцентный цвет на темном фоне */
        ...
        /** Акцентный цвет на светлом фоне */
        onLightTextAccentHover: '#79A7FBFF',
        /** Акцентный цвет на светлом фоне */
        ...
        surfaceTransparentDeepHover: '#FFFFFFC2',
        /** dark surface default surfaceTransparentDeepActive */
        surfaceTransparentDeepActive: '#FFFFFF94',
        ...
        surfaceSolidDefault: '#F9F9F9',
        /** Непрозрачный фон поверхности/контрола по умолчанию */
        surfaceSolidDefaultHover: '#FFFFFFFF',
        /** Непрозрачный фон поверхности/контрола по умолчанию */
        surfaceSolidDefaultActive: '#F5F5F5FF',
        ...
        /** Прозрачный фон для карточек */
        surfaceTransparentCardHover: '#FFFFFF3D',
        /** Прозрачный фон для карточек */
        surfaceTransparentCardActive: '#FFFFFF0F',
        /** Акцентный фон поверхности/контрола */
        surfaceAccentHover: '#5D95FDFF',
        /** Акцентный фон поверхности/контрола */
        ...
        onDarkSurfaceTransparentDeepHover: '#FFFFFFC2',
        /** dark surface onDark surfaceTransparentDeepActive */
        onDarkSurfaceTransparentDeepActive: '#FFFFFF94',
        /** dark surface onDark surfaceAccentMinor */
        onDarkSurfaceAccentMinor: '#1549AB',
        /** dark surface onDark surfaceAccentMinorHover */
        onDarkSurfaceAccentMinorHover: '#1852BFFF',
        /** dark surface onDark surfaceAccentMinorActive */
        onDarkSurfaceAccentMinorActive: '#1446A3FF',
        ...
        onDarkSurfaceSurfaceInfoHover: '#5D95FDFF',
        /** dark surface onDark surfaceSurfaceInfoActive */
        onDarkSurfaceSurfaceInfoActive: '#357BFDFF',
        ...
        onDarkSurfaceSolidDefault: '#F9F9F9',
        /** Непр. фон поверхности/контрола по умолчанию на тем. фоне */
        onDarkSurfaceSolidDefaultHover: '#FFFFFFFF',
        /** Непр. фон поверхности/контрола по умолчанию на тем. фоне */
        onDarkSurfaceSolidDefaultActive: '#F5F5F5FF',
        /** dark surface onDark surfaceSurfaceInfo */
        onDarkSurfaceSurfaceInfo: '#3F81FD',
        ...
        /** Прозрачный фон для карточек на темном фоне */
        onDarkSurfaceTransparentCardHover: '#FFFFFF3D',
        /** Прозрачный фон для карточек на темном фоне */
        ...
        onLightSurfaceInfoHover: '#5D95FDFF',
        /** dark surface onLight surfaceInfoActive */
        onLightSurfaceInfoActive: '#357BFDFF',
        ...
        outlineTransparentClear: '#FFFFFF00',
        /** dark outline default outlineTransparentClearHover */
        outlineTransparentClearHover: '#FFFFFF00',
        /** dark outline default outlineTransparentClearActive */
        outlineTransparentClearActive: '#FFFFFF00',
        ...
        outlineTransparentAccent: '#3F81FD47',
        /** dark outline default outlineTransparentAccentHover */
        outlineTransparentAccentHover: '#3F82FD66',
        /** dark outline default outlineTransparentAccentActive */
        outlineTransparentAccentActive: '#3F82FD38',
        ...
        outlineTransparentNegativeHover: '#F31B3152',
        /** dark outline default outlineTransparentNegativeActive */
        outlineTransparentNegativeActive: '#F31B3124',
        ...
        onDarkOutlinePrimaryActive: '#212121FF',
        /** dark outline onDark outlineSecondaryHover */
        onDarkOutlineSecondaryHover: '#595959FF',
        /** dark outline onDark outlineSecondaryActive */
        onDarkOutlineSecondaryActive: '#4A4A4AFF',
        /** dark outline onDark outlineTertiaryHover */
        onDarkOutlineTertiaryHover: '#7A7A7AFF',
        /** dark outline onDark outlineTertiaryActive */
        onDarkOutlineTertiaryActive: '#6B6B6BFF',
        ...
        onDarkOutlineTransparentAccentHover: '#3F82FD66',
        /** dark outline onDark outlineTransparentAccentActive */
        onDarkOutlineTransparentAccentActive: '#3F82FD38',
        ...
        onDarkOutlineTransparentPositiveHover: '#1A9E3266',
        /** dark outline onDark outlineTransparentPositiveActive */
        onDarkOutlineTransparentPositiveActive: '#1A9E3238',
        /** dark outline onDark outlineTransparentWarningHover */
        onDarkOutlineTransparentWarningHover: '#FA5F0566',
        /** dark outline onDark outlineTransparentWarningActive */
        onDarkOutlineTransparentWarningActive: '#FA5F0538',
        /** dark outline onDark outlineNegativeTransparentHover */
        onDarkOutlineNegativeTransparentHover: '#FF293E66',
        /** dark outline onDark outlineNegativeTransparentActive */
        onDarkOutlineNegativeTransparentActive: '#FF293E38',
        ...
        onDarkOutlineTransparentAccent: '#3F81FD47',
        ...
        onDarkOutlineTransparentPositive: '#1A9E3247',
        /** dark outline onDark outlineTransparentWarning */
        onDarkOutlineTransparentWarning: '#FA5F0547',
        /** dark outline onDark outlineNegativeTransparent */
        onDarkOutlineNegativeTransparent: '#FF293E47',
        ...
        onLightOutlinePrimaryActive: '#D9D9D9FF',
        ...
        onLightOutlinePositiveHover: '#1DAF37FF',
        /** dark outline onLight outlinePositiveActive */
        onLightOutlinePositiveActive: '#18952FFF',
        ...
        onLightOutlineWarningActive: '#F05B05FF',
        ...
        onLightOutlineInfoHover: '#5D95FDFF',
        /** dark outline onLight outlineInfoActive */
        onLightOutlineInfoActive: '#357BFDFF',
        ...
        onLightOutlineTransparentPositiveHover: '#1A9E3252',
        /** dark outline onLight outlineTransparentPositiveActive */
        onLightOutlineTransparentPositiveActive: '#1A9E3224',
        ...
        onLightOutlineNegativeTransparent: '#F31B3133',
        /** dark outline onLight outlineNegativeTransparentHover */
        onLightOutlineNegativeTransparentHover: '#F31B3152',
        /** dark outline onLight outlineNegativeTransparentActive */
        onLightOutlineNegativeTransparentActive: '#F31B3124',
    ...
    light: {
        ...
        textInfoHover: '#689CFDFF',
        /** light text default textInfoActive */
        textInfoActive: '#1767FDFF',
        ...
        onDarkTextInfoHover: '#689CFDFF',
        /** light text onDark textInfoActive */
        onDarkTextInfoActive: '#1767FDFF',
        ...
        onDarkTextParagraphActive: '#FFFFFFA3',
        /** Акцентный цвет на темном фоне */
        onDarkTextAccentHover: '#689CFDFF',
        /** Акцентный цвет на темном фоне */
        ...
        onLightTextParagraphActive: '#080808A3',
        /** Акцентный цвет на светлом фоне */
        onLightTextAccentHover: '#528DFAFF',
        /** Акцентный цвет на светлом фоне */
        ...
        surfaceInfoHover: '#689CFDFF',
        /** light surface default surfaceInfoActive */
        surfaceInfoActive: '#2B74FDFF',
        ...
        surfaceTransparentDeepHover: '#0808088F',
        /** light surface default surfaceTransparentDeepActive */
        surfaceTransparentDeepActive: '#080808AD',
        /** Осн. непрозрачный фон поверхности/контрола на темном фоне */
        onDarkSurfaceSolidPrimary: '#171717',
        /** Осн. непрозрачный фон поверхности/контрола на темном фоне */
        onDarkSurfaceSolidPrimaryBrightness: '#262626FF',
        ...
        onDarkSurfaceAccentMinorHover: '#1956C8FF',
        /** light surface onDark surfaceAccentMinorActive */
        onDarkSurfaceAccentMinorActive: '#13429AFF',
        ...
        onDarkSurfaceSurfaceInfoHover: '#689CFDFF',
        /** light surface onDark surfaceSurfaceInfoActive */
        onDarkSurfaceSurfaceInfoActive: '#2B74FDFF',
        ...
        onDarkSurfaceInfoMinorActive: '#061B41FF',
        ...
        onDarkSurfaceTransparentCardBrightness: '#FFFFFF1F',
        /** Прозрачный фон для карточек на темном фоне */
        onDarkSurfaceTransparentCardHover: '#FFFFFF0A',
        /** Прозрачный фон для карточек на темном фоне */
        ...
        onDarkSurfaceTransparentDeepHover: '#FFFFFF8F',
        /** light surface onDark surfaceTransparentDeepActive */
        onDarkSurfaceTransparentDeepActive: '#FFFFFFAD',
        /** Непр. фон поверхности/контрола по умолчанию на светлом фоне */
        onLightSurfaceSolidDefault: '#080808',
        /** Осн. непрозрачный фон поверхности/контрола на светлом фоне */
        onLightSurfaceSolidPrimary: '#F5F5F5',
        ...
        onLightSurfaceInfoHover: '#689CFDFF',
        /** light surface onLight surfaceInfoActive */
        onLightSurfaceInfoActive: '#2B74FDFF',
        ...
        outlineSecondaryActive: '#8A8A8AFF',
        /** light outline default outlineTertiaryHover */
        outlineTertiaryHover: '#858585FF',
        /** light outline default outlineTertiaryActive */
        outlineTertiaryActive: '#666666FF',
        ...
        outlineInfoHover: '#689CFDFF',
        /** light outline default outlineInfoActive */
        outlineInfoActive: '#2B74FDFF',
        ...
        outlineTransparentPositiveHover: '#1A9E321F',
        ...
        outlineTransparentWarningHover: '#FA5F051F',
        ...
        outlineNegativeTransparentHover: '#000000FF',
        /** light outline default outlineNegativeTransparentActive */
        outlineNegativeTransparentActive: '#CCCCCCFF',
        ...
        onDarkOutlineSecondaryActive: '#454545FF',
        /** light outline onDark outlineTertiaryHover */
        onDarkOutlineTertiaryHover: '#858585FF',
        /** light outline onDark outlineTertiaryActive */
        onDarkOutlineTertiaryActive: '#666666FF',
        ...
        onDarkOutlineTransparentAccentHover: '#3F82FD33',
        /** light outline onDark outlineTransparentAccentActive */
        onDarkOutlineTransparentAccentActive: '#3F82FD52',
        ...
        onDarkOutlinePositiveMinor: '#85380C',
        /** light outline onDark outlinePositiveMinorHover */
        onDarkOutlinePositiveMinorHover: '#95400EFF',
        /** light outline onDark outlinePositiveMinorActive */
        onDarkOutlinePositiveMinorActive: '#70300AFF',
        ...
        onLightOutlineSecondaryActive: '#8A8A8AFF',
        ...
        onLightOutlinePositiveActive: '#178C2CFF',
        ...
        onLightOutlineWarningActive: '#E65705FF',
        ...
        onLightOutlineInfoHover: '#689CFDFF',
        /** light outline onLight outlineInfoActive */
        onLightOutlineInfoActive: '#2B74FDFF',
        ...
        onLightOutlineTransparentPositiveHover: '#1A9E321F',
        ...
        onLightOutlineNegativeTransparentHover: '#F31B311F',
        /** light outline onLight outlineNegativeTransparentActive */
        onLightOutlineNegativeTransparentActive: '#F31B313D',
