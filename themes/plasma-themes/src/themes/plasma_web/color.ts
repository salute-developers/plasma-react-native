export const color = {
    ...
    light: {
        ...
        onDarkSurfaceSolidDefault: '#FFFFFFFF',
        /** Основной прозрачный фон поверхности/контрола на темном фоне */
        onDarkSurfaceTransparentPrimaryHover: '#363636FF',
        /** Основной прозрачный фон поверхности/контрола на темном фоне */
        onDarkSurfaceTransparentPrimaryActive: '#0D0D0DFF',
        /** Основной прозрачный фон поверхности/контрола на темном фоне */
        onDarkSurfaceTransparentPrimary: '#171717',
        /** Втор. прозрачный фон поверхности/контрола на темном фоне */
        onDarkSurfaceTransparentSecondaryHover: '#3B3B3BFF',
        /** Втор. прозрачный фон поверхности/контрола на темном фоне */
        onDarkSurfaceTransparentSecondaryActive: '#1C1C1CFF',
        /** Втор. прозрачный фон поверхности/контрола на темном фоне */
        onDarkSurfaceTransparentSecondary: '#262626',
        /** Трет. прозрачный фон поверхности/контрола на темном фоне */
        onDarkSurfaceTransparentTertiaryHover: '#4A4A4AFF',
        /** Трет. прозрачный фон поверхности/контрола на темном фоне */
        onDarkSurfaceTransparentTertiaryActive: '#2B2B2BFF',
        /** Трет. прозрачный фон поверхности/контрола на темном фоне */
